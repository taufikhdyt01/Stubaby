...
<body class="font-poppins my-auto">
    <header class="bg-transparent">
        <nav class="px-4 lg:px-6 py-2.5">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                <div class="flex items-center lg:order-2 lg:space-x-6 space-x-1 md:space-x-3">
                    @if(auth()->check())
    ...
    <section>
        ...
        <div class="relative overflow-hidden bg-cover bg-no-repeat p-12 text-center" style="background-image: url('/img/bg_landing.svg'); height: 800px">
            <div class="absolute bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-fixed" style="background: linear-gradient(0deg, rgba(55, 35, 52, 0.15) 0%, rgba(55, 35, 52, 0.15) 100%), linear-gradient(110deg, #F6D2FF 15.73%, rgba(217, 217, 217, 0.00) 87.48%);">
                <div class="flex h-full items-center ">
                    <div class="text-blek lg:ml-32 md:ml-16 mx-8 text-left md:text-center ">
        ...
        <!-- 2 -->
        <div class="lg:flex md:flex lg:mx-32 md:mx-16 mx-8 my-32 lg:space-x-20 md:space-x-10 ">
        ...
        <!-- 3 -->
        <div class="bg-primary lg:pb-16 pb-8 ">
            <div class="lg:mx-32 md:mx-16 mx-8  lg:pb-16 md:pt-24 pt-8 pb-8 text-white">
                <h2 class="font-bold lg:text-[38px] md:text-[30px] text-[24px] text-center justify-center mb-4">
                    Tersedia 3 fitur yang siap melayani Anda
                </h2>
                <p class="lg:text-[18px] md:text-[16px] text-[14px] text-center">
            ...
            <div class="lg:flex md:flex lg:flex-row md:flex-row flex flex-col items-center align-center justify-center lg:space-x-10 md:space-x-5 text-center space-y-5 md:space-y-0 lg:space-y-0">
                <!-- 3.1 -->
                <div class="bg-white rounded-xl w-[250px] lg:w-[350px] md:w-[350px] lg:py-8 lg:px-16 md:py-6 md:px-14 py-4 px-12">
                    <img class="w-auto h-auto" src="{{ asset('/img/img_chat.svg') }}" alt="">
                    <h5 class="lg:text-[24px] md:text-[20px] text-[16px] font-bold mt-6">
                        Konsultasi
                    </h5>
                    <h6 class="lg:text-[14px] md:text-[12px] text-[10px] mt-3">
                ...
                <!-- 3.3 -->
                <div class="bg-white rounded-xl w-[250px] lg:w-[350px] md:w-[350px] lg:py-8 lg:px-16 md:py-6 md:px-14 py-4 px-12">
                    <img class="w-auto h-auto" src="{{ asset('/img/artikel3.svg') }}" alt="">
                    <h5 class="lg:text-[24px] md:text-[20px] text-[16px] font-bold mt-6">
                        Artikel
                    </h5>
                    <h6 class="lg:text-[14px] md:text-[12px] text-[10px] mt-3">
                        Ibu rumah tangga dapat membaca berbagai macam artikel yang disediakan dan diberikan secara terpercaya oleh ahli gizi kami
                    </h6>
                </div>
            </div>
        </div>
        ...
        <!-- 4 -->
        <div class="lg:mx-32 md:mx-16 mx-8 my-32">
