        ...
        <div class="flex flex-col flex-1 w-full ml-16">
            ...
            <main class="h-full overflow-y-auto">
                ...
                <div class="bg-white p-4 shadow-md rounded-lg my-5 mx-20">
                    ...
                    <form method="post" action="{{ route('admin.update', $anak->id) }}?success"
                        enctype="multipart/form-data" onsubmit="showSuccessPopup()">
                        @csrf
                        @method('PATCH')
                        <div class="mt-4">
                            <label for="user_id">Pilih User:</label>
                            <select id="user_id" name="user_id" class="w-full border border-gray-300 rounded-md p-2">
                        ...
                        <div class="mt-4">
                            ...
                            <input value="{{ $anak->nama_anak }}" type="text" name="nama_anak"
                                class="w-full border border-gray-300 rounded-md p-2"required>
                        </div>

                        <div class="mt-4">
                            <label for="tanggal_lahir">Tanggal Lahir:</label>
                            <input value="{{ $anak->tanggal_lahir }}" type="date" name="tanggal_lahir"
                        ...
                        <div class="mt-4">
                            ...
                            <input value="{{ $anak->tinggi_badan }}" type="number" name="tinggi_badan"
                                class="w-full border border-gray-300 rounded-md p-2" required>
                        ...
                        <div class="mt-4">
                            ...
                            <input value="{{ $anak->berat_badan }}" type="number" name="berat_badan"
                                class="w-full border border-gray-300 rounded-md p-2" required>
                        </div>

                        <div class="mt-4">
                            <label for="berat_badan">Catatan:</label>
                            <textarea value="{{ $anak->catatan }}" id="catatan" name="catatan" rows="4"
                        ...
                        <div class="mt-4">
                            <button type="submit" @click.prevent="showNotification"
                                class="bg-indigo-500 text-white py-2 px-4 rounded-lg">Simpan data</button>
                        </div>
                        <div class="mt-5"></div>
