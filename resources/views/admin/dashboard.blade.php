    ...
    <div class="flex h-screen bg-gray-50" :class="{ 'overflow-hidden': isSideMenuOpen }">
        ...
        <div class="flex flex-col flex-1 w-full ml-16">
            ...
            <main class="h-full overflow-y-auto">
                ...
                <div class="mt-5 text-xl font-semibold text-gray-700 ml-20 pl-5">Anak</div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div class="mx-20 bg-white rounded-lg shadow-md p-10">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <p class="text-gray-500">Total Anak Terdaftar</p>
                                    <p class="text-2xl font-semibold">{{ $anakCount }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
