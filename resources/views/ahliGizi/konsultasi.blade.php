...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5" />
            ...
            <div>
                ...
                <select class="py-2 px-4 border border-gray-300 rounded-md">
                    <option value="selesai">Selesai</option>
                    <option value="pending">Pending</option>
                </select>
            </div>
            <div class="relative mx-5">
                <input type="text" class="py-2 px-4 border border-gray-300 rounded-md w-96" placeholder="Cari">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
            ...
            <button class="bg-indigo-500 text-white py-2 px-4 rounded-md">Terapkan</button>
        </div>
    </div>
</div>
...
<div class="bg-white p-4 shadow-md rounded-lg my-5 mx-20">
  ...
  <path d="M5.25 5.25a3 3 0 00-3 3v10.5a3 3 0 003 3h10.5a3 3 0 003-3V13.5a.75.75 0 00-1.5 0v5.25a1.5 1.5 0 01-1.5 1.5H5.25a1.5 1.5 0 01-1.5-1.5V8.25a1.5 1.5 0 011.5-1.5h5.25a.75.75 0 000-1.5H5.25z" />
      ...
      <!-- Tambahkan baris data tiket lainnya sesuai kebutuhan Anda -->
    </tbody>
  </table>
</div>
  ...
  document.addEventListener('DOMContentLoaded', function () {
    const dateInput = document.querySelector('#date-input'); // Ganti dengan ID input tanggal Anda
    const calendarIcon = document.querySelector('#calendar-icon'); // Ganti dengan ID ikon kalender Anda
    ...
    flatpickr(dateInput, {
      ...
      onClose: function (selectedDates, dateStr, instance) {
        // Tangani perubahan tanggal di sini, misalnya:
        console.log(dateStr); // Tampilkan tanggal yang dipilih di konsol
      },
    });
