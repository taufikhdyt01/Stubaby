            ...
            <main class="h-full overflow-y-auto">
                <div class="bg-white p-4 shadow-md rounded-lg my-5 mx-20">
                    ...
                    <form method="post" action="{{ route('konten.update', $konten->id) }}"
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" id="judul_artikel" name="judul_artikel"
                                    class="w-full border border-gray-300 rounded-md p-2" value="{{ $konten->judul }}">
                            </div>
                            <div>
                        ...
                        <div class="mt-4">
                            <a href="/ahligizi/konten"><button type="button"
                                    class= "bg-white text-indigo-500 border border-indigo-500 py-2 px-4 rounded-lg mr-5">Batal
                                    Perubahan</button></a>
                            <button type="submit" class="bg-indigo-500 text-white py-2 px-4 rounded-lg">Simpan
                                Perubahan</button>
                        </div>
                    </form>
                </div>
