        ...
        <div class="flex flex-col flex-1 w-full ml-16">
            ...
            <main class="h-full overflow-y-auto">
                ...
                <div class="bg-white p-4 shadow-md rounded-lg my-5 mx-20">
                    ...
                    <form method="post" action="{{ route('konten.store') }}?success" enctype="multipart/form-data"
                        ...
                        <div class="mt-4">
                            <button type="submit" @click.prevent="showNotification"
                                class="bg-indigo-500 text-white py-2 px-4 rounded-lg">Tambah Artikel</button>
                        </div>
