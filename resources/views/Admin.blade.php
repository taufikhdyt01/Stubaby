...
<body class="font-sans bg-gray-100">
    ...
    <div class="ml-16 p-4">
        ...
        <h1 class="text-2xl font-semibold mb-4">Data Anak dalam Frame</h1>
        <div class="frame">
            <h2 class="text-xl font-semibold">Nama Anak: John</h2>
            <p class="text-gray-600">Nama Ibu: Maria</p>
            <button class="bg-blue-500 text-white px-2 py-1 rounded hover:bg-blue-700">Detail</button>
        </div>

        <div class="frame">
            <h2 class="text-xl font-semibold">Nama Anak: Alice</h2>
            <p class="text-gray-600">Nama Ibu: Linda</p>
            <button class="bg-blue-500 text-white px-2 py-1 rounded hover:bg-blue-700">Detail</button>
        </div>
